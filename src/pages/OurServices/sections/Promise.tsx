...
export default function PromiseSection() {
  return (
    <section className="relative mx-auto max-w-5xl text-ink">
      <Orb color="sage" className="-right-[200px] top-0 h-[280px] w-[280px] lg:h-[450px] lg:w-[450px]" opacity={0.35} />

      <div className="relative z-10">
        <h3 className="font-sans text-[16px] font-bold text-forest sm:text-[18px]">Our promise</h3>
        <h2 className="mb-5 font-display text-[32px] font-bold sm:mb-6 sm:text-[40px] lg:text-[44px]">What Can You Expect</h2>
