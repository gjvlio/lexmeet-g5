    ...
    children: [
      ...
      _jsxs("div", {
        ...
        children: [
          ...
          _jsxs("div", {
            className:
              "space-y-5 font-sans text-[16px] leading-relaxed text-ink/80 sm:text-[18px] max-h-[180px] sm:max-h-[220px] overflow-y-auto pr-3 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-sage/50 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-sage/80",
            children: [
              _jsx("p", {
                children:
      ...
      _jsx("div", {
        ...
        children: _jsx("img", {
          ...
          className:
            "h-[280px] w-full max-w-[920px] rounded-tl-[40px] rounded-br-[40px] rounded-tr-[24px] rounded-bl-[24px] object-cover sm:h-[380px] lg:h-[400px] lg:rounded-tl-[80px] lg:rounded-br-[80px]",
        }),
      }),
    ],
  });
