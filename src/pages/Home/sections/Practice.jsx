...
export default function Practice() {
  return _jsxs("section", {
    ...
    children: [
      _jsx("div", {
        className:
          "pointer-events-none absolute inset-0 bg-gradient-to-b from-mist via-forest to-ink",
      }),
      _jsx("div", {
        className:
          "pointer-events-none absolute inset-0 bg-ink/40 mix-blend-multiply",
      }),
      _jsxs("div", {
        ...
        children: [
          _jsxs("div", {
            className:
              "relative mb-8 h-[48px] sm:h-[80px] lg:mb-10 lg:h-[150px]",
            children: [
              _jsx("h2", {
                className:
                  "absolute left-0 top-0 font-display text-[48px] font-bold leading-none text-cream sm:text-[80px] lg:text-[150px]",
                children: "PRACTICE",
              }),
              _jsx("h2", {
                "aria-hidden": true,
                className:
                  "absolute left-0 top-0 font-display text-[48px] font-bold leading-none text-transparent [-webkit-text-stroke:1px_theme(colors.sage)] [clip-path:inset(50%_0_0_0)] sm:text-[80px] lg:text-[150px]",
                children: "PRACTICE",
              }),
            ],
          }),
          _jsxs("div", {
            ...
            children: [
              _jsx("div", {
                ...
                children: PRACTICE_AREAS.map((p, i) => {
                  ...
                  return _jsxs(
                    "article",
                    {
                      className: cn(
                        ...
                        bigLeft
                          ? "rounded-tl-[48px] lg:rounded-tl-[80px]"
                          : "rounded-tr-[48px] lg:rounded-tr-[80px]",
                      ),
                      children: [
                        _jsx("div", {
                          className: cn(
                        ...
                        _jsxs("div", {
                          children: [
                            _jsx("h3", {
                              className:
                                "font-display text-2xl font-bold text-ink lg:text-[32px]",
                              children: p.title,
                            }),
                            _jsx("p", {
                              className:
                                "mt-2 font-sans text-[13px] leading-[1.42] text-deep",
                              children: p.body,
                            }),
                          ],
                        }),
