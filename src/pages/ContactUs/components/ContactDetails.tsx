...
function IconBadge({ children }: { children: React.ReactNode }) {
  return (
    <span className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-olive-leaf text-parchment shadow-pill">
      {children}
    </span>
  );
}
...
export default function ContactDetails() {
  return (
    <div>
      ...
      <h1 className="mt-10 font-display text-4xl font-bold text-carbon-black">Contact Us</h1>
      <p className="mt-4 font-sans text-[15px] leading-relaxed text-dark-khaki">
        We&rsquo;d love to hear from you! Whether you have a question, need a quote, or want to learn
        more about our services, feel free to get in touch. Send us a message using the form or
        contact us through our phone number or email.
      </p>
